...
print(
  """You rush out bed, getting dressed in most of your climbing hear along the way.
...
while question == 2:
    ...
    if loc2 == "inventory" or loc2 == "check inventory":
        if playerinv == "":
            ...
            print("Inventory\n********")
            print(playerinv)
    elif loc2 == "go north" or loc2 == "climb mountain" or "continue" in loc2 or loc2 == "head north":
...
With a small glance to the unfortunate adventurer down below, you press on and are determined you will not meet the same fate.\n""")
    ...
    print(
      "The strange beauty of the cave mystifies you. The juxtaposition of the corpse against the alluring cave makes you sick to your stomache.")
...
(Only the flare will defend you against this animal.)""")
    ...
    while question == 5:
        leopardquestion = input("What do you do?: ")
...
Your axe is not made for combat, after one good swing though, it backs off. You are still in a stalemate.""")
...
while question == 7:
  ...
  if loc7 == "inventory" or loc7 == "check inventory":
    ...
    print(
      "You decide to keep going, and leave the gem behind. It's not worth the effort and/or time."
    )
    question = 8
    break
  elif ("keep going" in loc7 or "continue" in loc7
    ...
    print(
      "You've decided to get the gem, it was too captivating to leave behind. With the gem stashed safely in your backpack, you continue."
    )
    question = 8
    break
...
Maybe you should use an item of some kind?""")
      ...
      "get gem") and ("with axe") in loc7 or ("use axe") in loc7 and gem == 1:
    print("You've already gotten the gem in the wall.")
  elif ("grab gem") and ("with axe") in loc7 or ("get gem") and (
      "with axe") in loc7 or ("use axe") in loc7 and gem == 0:
    print(
      """You decide to use your climbing ice axe as a makeshift pickaxe to mine the gem out.
...
if question == 9:
  print(
    """With the warning from the dwarf still fresh in your mind, you can already see the peak grow larger and larger.
...
Atleast you take some solace in the fact the worst is most likely now over, and continue on."""
          ...
          print(
            "Give me a whole number, this will still count as a guess by the way."
          )
      else:
...
if question == 10:
  print(
    """You narrowly escaped the Yeti's cruel tricks, and now stand near the peak of the mountain.
...
while question == 10:
  ...
  if loc10 == "inventory" or loc10 == "check inventory":
    ...
    print(
      "It just looks like a regular mountain side to you. Even when you touch the wall physically, nothing seems off."
    )
  elif loc10 == "look at snow" or loc10 == "inspect snow":
    print(
      """The huge pack of snow blocks anything trying to cross it. So tightly packed it might aswell be an iron sheet.
You aren't a bad climber, but even this one would be impossible for you.""")
    ...
    print(
      """You decide to hold the amulet next to the wall, hoping the dwarf told you the truth. 
...
if question == 11:
  print(
    """After walking trough the grandiose hallway for what seems an eternity, you come across a large inner sanctum.
...
There is also a large mechanical button on the side of the stand.""")
      while "approach" in loc11 or "inspect" in loc11 or "check" in loc11 or "enter" in loc11 and "elevator" in loc11:
        ...
        or "press button" in elevatorquestion and dwarfkey == 0:
          print(
            """You press the large mechanical button on the side of the stand, the elevator starts rising up slowly.
...
This time it is alot smaller, however. You leave the sanctum and approach the peak of the mountain."""
          ...
          print(
            """You insert the dwarven key into the keyhole, the elevator immediately reacts and starts running.
The elevator shakes and vibrates so violently you are nearly knocked off your feet. You assume you now need to press the button to make it go up."""
        ...
        or "press button" in elevatorquestion and dwarfkey == 1:
          print(
            """You try to use the button on the side, however the elevator is still dormant and nothing happens. 
